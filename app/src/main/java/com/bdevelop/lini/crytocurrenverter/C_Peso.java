...
public class C_Peso extends calngn {
    TextView currency;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.btc_colombia);
    ...
    public void calculateResult() throws NumberFormatException {
        ...
        if (editableValue1 != null) {
            try {
                ...
                result = amt * 17637442.14;

                // Displays the calculated result

                resultsText.setText(Double.toString(result) + " " + "Colombian Peso");
            }
            //Handles empty editText field
